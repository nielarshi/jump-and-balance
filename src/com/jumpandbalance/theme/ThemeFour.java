...
public class ThemeFour implements Theme {
	...
	public ThemeFour(Context context) {
		this.context = context;
		this.setTheme();
	}
	...
	public void setTheme() {
		this.pillarBitmap = BitmapFactory.decodeResource(this.context.getResources(), R.drawable.pillar_16);
		this.ballBitmap = ImageHelper.getInstance().getImageFor(ImageHelper.HOME_BALL_2);
		this.backgroundImageBitmap = BitmapFactory.decodeResource(this.context.getResources(), R.drawable.undergroundwater);
