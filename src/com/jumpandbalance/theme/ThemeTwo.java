...
public class ThemeTwo implements Theme {
	...
	public ThemeTwo(Context context) {
		this.context = context;
		this.setTheme();
	}
	...
	public void setTheme() {
		this.pillarBitmap = BitmapFactory.decodeResource(this.context.getResources(), R.drawable.pillar_15);
		this.ballBitmap = ImageHelper.getInstance().getImageFor(ImageHelper.HOME_BALL_5);
		this.backgroundImageBitmap = BitmapFactory.decodeResource(this.context.getResources(), R.drawable.t6);
		this.isStill = true;
