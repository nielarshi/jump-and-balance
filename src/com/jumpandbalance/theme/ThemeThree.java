...
public class ThemeThree implements Theme {
	...
	public ThemeThree(Context context) {
		this.context = context;
		this.setTheme();
	}
	...
	public void setTheme() {
		this.pillarBitmap = BitmapFactory.decodeResource(this.context.getResources(), R.drawable.ice_pillar);
		this.ballBitmap = ImageHelper.getInstance().getImageFor(ImageHelper.HOME_BALL_7);
		this.backgroundImageBitmap = BitmapFactory.decodeResource(this.context.getResources(), R.drawable.snow_small);
		this.isStill = true;
