...
public class Butterfly11 {
	...
	private int count;
	private int currentFrame, currentYFrame = 1;
	private boolean isForward = true;
	GameOverConfirmation gocObj;
	private boolean isDrawn;

	public Butterfly11(GameOverConfirmation gocObj) {
		this.x = 650;
		this.y = 420;
		this.butterfly1 = ImageHelper.getInstance().getImageFor(
				ImageHelper.BUTTERFLY_ELEVEN);
